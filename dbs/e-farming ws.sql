...
--
CREATE DATABASE IF NOT EXISTS `e-farming_ws` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE `e-farming_ws`;
...
('root', 'e-farming_ws', 'products', '{\"sorted_col\":\"`products`.`userRef` DESC\"}', '2023-07-03 08:04:13'),
('root', 'e-farming_ws', 'users', '{\"sorted_col\":\"`userID` ASC\"}', '2023-05-19 12:53:25');
