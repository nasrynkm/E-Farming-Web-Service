// Function to fetch, search, and display products based on category, userRef, searchKeyword, and sortOrder
        ...
        document
          ...
          .addEventListener("click", function () {
            ...
            */
                ...
                profileImageElement.id = "profileImage";
                ...
                fnameElement.id = "fname";

                var lnameElement = document.createElement("p");
                lnameElement.id = "lname";

                var locationedElement = document.createElement("p");
                locationedElement.id = "locationed";

                var phoneNumberElement = document.createElement("p");
                phoneNumberElement.id = "phoneNumber";
                ...
                nameContainer.appendChild(fnameElement);
                nameContainer.appendChild(lnameElement);
                nameContainer.appendChild(locationedElement);
                nameContainer.appendChild(emailElement);
                nameContainer.appendChild(phoneNumberElement);

                detailsContainer.appendChild(imageContainer);
                detailsContainer.appendChild(nameContainer);

                popupModal.appendChild(closeBtn);
                popupModal.appendChild(detailsContainer);
                ...
                // Function to open the popup and populate the details
                function openPopup(
                  fname,
                  lname,
                  locationed,
                  ...
                  profileImageElement.src = "../uploaded/" + profileImage;
                  fnameElement.textContent = "First Name: " + fname;
                  lnameElement.textContent = "Last Name: " + lname;
                  locationedElement.innerHTML =
                    '<i class="fa-solid fa-location-dot"></i> ' + locationed;
                  phoneNumberElement.innerHTML =
                    '<i class="fa-brands fa-whatsapp"></i> ' + phoneNumber;
                  ...
                  phoneNumberElement.addEventListener("click", function () {
                    var phoneNumber = phoneNumberElement.textContent.replace(
                      "Phone: ",
                      ""
                    );
                    // Remove spaces or special characters from the phone number
                    ...
                    if (phoneNumber.startsWith("0")) {
                      ...
                      // Check if the device supports deep linking for WhatsApp
                      if (
                        /Android|webOS|iPhone|iPad|iPod|BlackBerry|IEMobile|Opera Mini/i.test(
                          navigator.userAgent
                        )
                      ) {
                        // If deep linking is supported, open WhatsApp with the phone number
                        window.open(
                          "https://api.whatsapp.com/send?phone=" +
                            encodeURIComponent(phoneNumber)
                        );
                      } else {
                        // If deep linking is not supported, initiate a normal phone call
                  ...
                  emailElement.addEventListener("click", function () {
                    var email = emailElement.textContent.replace("Email: ", "");
                    var subject = "E-FARMING WEB SERVICE, CUSTOMER"; // Optional
                    var body = ""; // Optional

                    // Construct the Gmail compose URL with recipient email address, subject, and body
                    var gmailComposeUrl =
                ...
                contactButton.addEventListener("click", function () {
                  // Simulating passing of details
                  const fname = product.firstName;
                  const lname = product.lastName;
                  const locationed = product.locationed;
                  const phoneNumber = product.phone;
                  const email = product.email;
                  const profileImage = product.profilePhoto;
